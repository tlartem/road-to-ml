...
def validate(df, table_name, checks_file=None):
    ...
    Args:
        ...
        table_name: logical table name (maps to checks/{table_name}.yaml)
        checks_file: path to YAML checks file (default: checks/{table_name}.yaml)
...
def validate_and_push(df, table_name, checks_file=None, fail_on_error=True):
    ...
    This is the main entry point for all pipeline scripts.
    """
